![docker image](https://github.com/budschi/deletelater_nomadoasisimage/actions/workflows/docker-publish.yml/badge.svg)


# budschi's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of budschi.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/budschi/deletelater_nomadoasisimage.git
    cd deletelater_nomadoasisimage
    ```

    or

    ```sh
    curl-L -o deletelater_nomadoasisimage.zip "https://github.com/budschi/deletelater_nomadoasisimage/archive/main.zip"
    unzip deletelater_nomadoasisimage.zip
    cd deletelater_nomadoasisimage
    ```
...
your `docker-compose.yaml` with `ghcr.io/budschi/deletelater_nomadoasisimage:main` for the services
...
```sh
docker pull ghcr.io/budschi/deletelater_nomadoasisimage/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/budschi/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/budschi/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/budschi/deletelater_nomadoasisimage/manifests/main": unauthorized`
